 ...
 * Fri Sep 25 2020 13:36:47 GMT+0545 (Nepal Time)
...
var input_range_start, input_range_end, result_range_start, result_range_end, input_value, result_range, output_value, current_scroll;
...
setHTMLElemStyle('minHeight', '3800', ['BODY'], false);
...
eventHTMLElem('scroll', ['WINDOW'], false, function(event) {
  ...
  if (current_scroll < 3000) {
    ...
    operateAnimation('SET_FRAME', getAnimations('Armature'), map_range(0, 3000, 0, 180, current_scroll), null, 'AUTO', 1,
            function() {}, undefined, false);


    operateAnimation('SET_FRAME', getAnimations('Camera.001'), map_range(0, 3000, 0, 180, current_scroll), null, 'AUTO', 1,
            function() {}, undefined, false);


    operateAnimation('SET_FRAME', getAnimations(['GROUP', 'labels']), map_range(0, 3000, 0, 180, current_scroll), null, 'AUTO', 1,
            function() {}, undefined, false);
